...
def callback(ch, method, properties, body):
    ...
    if progress_bar_value == 100: kivy_app.ids.alerts_label.text = 'Data generated successfully!'

if __name__ == "__main__":

    repo = DbRepo(local_session)
    repo_thread = Thread(target=repo.reset_auto_inc)
    repo_thread.start()
