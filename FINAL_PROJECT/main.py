...
# db_refresh
# repo.reset_db()
some_flight = Flights(id=222, airline_company_id=2, origin_country_id=321, destination_country_id=2, departure_time=datetime(2025, 1, 1, 10, 10, 10), landing_time=datetime(2026, 1, 24, 10, 29, 1), remaining_tickets=3)
# some_ticket = Tickets(flight_id=222, customer_id=2)
print("#"*55)
print(some_flight)
# print(some_ticket)
print(some_flight.data_for_web())
