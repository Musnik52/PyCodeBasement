...
class Flights(Base):
    ...
    desitnation_country_id = Column(BigInteger(), ForeignKey('countries.id'), unique=False, nullable=False)
    ...
    destination = relationship("Countries", foreign_keys = [desitnation_country_id] , uselist=True)
