...
airline_facade.add_all_airlines(airline_companies_list := [AirlineCompanies(name='bazooka air', country_id=1, user_id=1), AirlineCompanies(name='sky high', country_id=2, user_id=2)])
admin_facade.add_all_administrators(admins_list := [Administrators(first_name='lior', last_name='musnik', user_id=2), Administrators(first_name='boris', last_name='musnikov', user_id=1)]) 
customer_facade.add_all_customers(customers_list := [Customers(first_name='shachar', last_name='harush', address='rashi 31', phone_number='0507897765', credit_card_number='13323432', user_id=1), Customers(first_name='max', last_name='gendalev', address='amsterdam 32', phone_number='0523452231', credit_card_number='13245678', user_id=2)])
repo.add_all(flights_list := [Flights(airline_company_id=1, origin_country_id=1, desitnation_country_id=2, departure_time=datetime.now(), landing_time=datetime(2022, 10, 4, 14, 29, 1), remaining_tickets=3), Flights(airline_company_id=2, origin_country_id=2, desitnation_country_id=1, departure_time=datetime.now(), landing_time=datetime(2022, 12, 4, 23, 29, 1), remaining_tickets=432)])
