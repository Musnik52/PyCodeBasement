...
anonymus_facade.create_user(    Users(username='b0r1s', password='boris1992', email='boris@jb.com', user_role=2))
anonymus_facade.create_user(    Users(username='m4x1m', password='2themax', email='max@jb.com', user_role=2))
anonymus_facade.create_user(    Users(username='k0st4', password='1kosta1', email='kosta@jb.com', user_role=3))
anonymus_facade.create_user(    Users(username='3m1l', password='e0m1i2l', email='emil@jb.com', user_role=3))
admin_facade.add_airline(       AirlineCompanies(name='bazooka air', country_id=1, user_id=3)) 
admin_facade.add_airline(       AirlineCompanies(name='sky high', country_id=2, user_id=4))
admin_facade.add_administrator( Administrators(first_name='lior', last_name='musnik', user_id=2))
admin_facade.add_administrator( Administrators(first_name='shachar', last_name='harush', user_id=1)) 
...
customer_facade.add_customer(   Customers(first_name='emil', last_name='tayeb', address='amsterdam 32', phone_number='0523452231', credit_card_number='13245678', user_id=6))
